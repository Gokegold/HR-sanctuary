...
const navigationItems = [
  ...
  { name: "Break Center", icon: Coffee, path: "/employee/break-center", current: false },
  { name: "Emergency", icon: AlertTriangle, path: "/employee/emergency", current: false },
  { name: "Tasks", icon: CheckCircle, path: "/employee/tasks", current: false },
  { name: "Notifications", icon: Bell, path: "/employee/notifications", current: false },
  { name: "Compliance", icon: FileText, path: "/employee/compliance", current: false },
];
          ...
          <div className="p-4">
            ...
            <div className="flex items-center gap-3 mb-6 p-3 bg-muted/50 rounded-lg">
              ...
              <div className="flex-1 min-w-0">
                ...
                <Badge variant="outline" className="text-xs mt-1">ID: {user.employeeId}</Badge>
              </div>
            </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-primary">{productivityScore}%</p>
                    </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-medium">Break ended - returned to active status</p>
                      ...
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-medium">15-minute break started</p>
