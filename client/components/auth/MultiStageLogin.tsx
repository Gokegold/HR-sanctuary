...
export default function MultiStageLogin({ onSuccess }: MultiStageLoginProps) {
  ...
  const [wearableToken, setWearableToken] = useState<WearableToken | null>(
    null,
  );
  ...
  const handleTokenVerification = async () => {
    ...
    try {
      ...
      if (tokenInput === wearableToken.code) {
        ...
        setError(
          "Invalid token. Please check the code on your wearable device.",
        );
        setTokenInput("");
      }
    } catch (err) {
  ...
  const skipWearableAuth = async () => {
    ...
    setError(
      "Wearable authentication skipped. Login requires manual HR approval.",
    );
          ...
          {currentStage === "biometric" && (
            <div className="space-y-4">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Use your{" "}
                  {biometricType === "face" ? "Face ID" : "fingerprint"} to
                  continue
                </p>
              </div>
              ...
              {wearableConnected ? (
                  ...
                  {wearableToken && (
                    <div className="space-y-4">
                      <Alert>
                        ...
                        <AlertDescription>
                          Check your wearable device for a 6-digit verification
                          code.
                          <br />
                ...
                <div className="space-y-4">
                  <div className="text-center py-6">
                    ...
                    <Badge variant="destructive">Wearable Not Connected</Badge>
                  </div>

                  <Alert>
                    <Smartphone className="h-4 w-4" />
                    <AlertDescription>
                      Your wearable device is not connected. Please ensure it's
