...
const apps = [
  {
    ...
    description:
      "Biometric check-in, task management, and real-time status tracking",
    icon: Activity,
    color: "pulse-blue",
    features: [
      "Biometric Sign-in",
  ...
  },
  {
    ...
    description:
      "Live attendance tracking, compliance monitoring, and team analytics",
    icon: Users,
    color: "pulse-green",
    features: [
      "Live Tracking",
  ...
  },
  {
    ...
    description:
      "Department overview, performance management, and team leadership",
    icon: Command,
    color: "pulse-orange",
    features: [
      "Team Overview",
  ...
  },
  {
    ...
    description:
      "Organization-wide intelligence, predictive analytics, and executive insights",
    icon: Brain,
    color: "pulse-purple",
    features: [
      "Bird's-eye View",
...
const features = [
  {
    ...
    description:
      "Biometric authentication with geofence validation and encrypted sessions",
  },
  {
    icon: Clock,
    title: "Real-time Monitoring",
    description:
      "Live presence tracking with 50,000+ events per minute capacity",
  },
  {
    icon: BarChart3,
    title: "Advanced Analytics",
    description:
      "Productivity intelligence with predictive insights and board-ready reports",
  },
  {
    icon: Heart,
    title: "Health Integration",
    description:
      "Wearable pulse monitoring with burnout prevention and wellness tracking",
  },
];
        ...
        <div className="relative container mx-auto px-4 py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Real-Time Employee Integrity & Presence Monitoring Ecosystem for
              institutional monitoring, ensuring presence, performance,
              accountability, and compliance through intelligent workforce
              analytics.
            </p>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Built for mission-critical environments with the highest standards
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground">
            Live status indicators and productivity metrics across your entire
            organization
          </p>
        </div>
        ...
        <div className="bg-card border rounded-lg p-6">
          ...
          <div className="text-center">
            <p className="text-sm text-muted-foreground mb-4">
              🔄 Updates every 30 seconds • 📊 Real-time analytics • 🎯
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-sm text-muted-foreground text-center md:text-right">
              Real-Time Employee Integrity & Presence Monitoring
              <br />
